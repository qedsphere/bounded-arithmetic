...
and the following equivalency:

\begin{theorem}
    $S^1_2\ne BT$ iff $S^1_2$ does not prove $\dWPHP(CV)$%; $S^1_2\preceq_{\Sigma^b_1} BT$ iff $S^1_2$ does not prove $\dWPHP_1(CV, CV)$.
\end{theorem}
...
Namely, $g$ is the truth-table functoin. However, it is not known whether this is true for $S^1_2(\PV_1)$. 